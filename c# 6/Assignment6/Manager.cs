...
namespace ConsoleApp1
{
    ...
    {
        public delegate void EmployeeDelegate();//Creation of delegate
        ...
        {
            Console.WriteLine("the gross salary of manager is: " + this.GrossSalary);
            Console.WriteLine("the net salary of manager is: " + this.NetSalary);
        }
        ...
        public static void Main()
        {
            ...
            manager.displayEmp();
            Manager.EmployeeDelegate deleg = new Manager.EmployeeDelegate(manager.displayEmp);
            deleg();
        }
    }  
}
